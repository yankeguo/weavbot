...
class WeavbotDingTalkHandler(CallbackHandler):
    ...
    Parses incoming messages and forwards them to the Weavbot channel.
    """
    ...
    async def process(self, message: CallbackMessage):
        ...
        try:
            ...
            # Forward to Weavbot via _on_message (non-blocking).
...
class DingTalkChannel(BaseChannel):
    ...
    def __init__(self, config: DingTalkConfig, bus: MessageBus, workspace: Path, state=None):
    ...
    async def _send_markdown_text(self, token: str, chat_id: str, content: str) -> bool:
        return await self._send_batch_message(
            ...
            chat_id,
            "sampleMarkdown",
            {"text": content, "title": "Weavbot Reply"},
        )
