...
try:
    ...
    raise ImportError(
        "Matrix dependencies not installed. Run: pip install weavbot-ai[matrix]"
    ) from e

from weavbot.bus.events import OutboundMessage
from weavbot.channels.base import BaseChannel
from weavbot.config.loader import get_data_dir
from weavbot.utils.helpers import safe_filename
